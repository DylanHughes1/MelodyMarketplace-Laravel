                        ...
                        <div class="container mx-auto">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    @foreach($order->details->sortBy('id') as $detail)
                                    <tr>
                                        <td class="px-6 py-4 bg-white font-medium text-gray-900 border-b dark:bg-gray-800 dark:border-gray-700">
                                            <div class="text-center">
                                                ...
                                                <div class="mt-4 space-x-2"> 
                                                    ...
                                                    <button type="button" data-modal-target="default-modal-{{$detail->product->id}}" data-modal-toggle="default-modal-{{$detail->product->id}}" href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">
                                                        Editar
                                                    </button>

                                                    <div id="default-modal-{{$detail->product->id}}" aria-hidden="true" class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
                                                            ...
                                                            <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                                                                <form method="POST" class="space-y-6" action="/details/{{$detail->id}}#" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-600">
                                                                        ...
                                                                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="default-modal-{{$detail->product->id}}">
                                                                    ...
                                                                    <div class="flex space-x-2 items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-600">
                                                                        <button type="submit" data-modal-toggle="default-modal-{{$detail->product->id}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save all</button>
                                                                        <button type="button" data-modal-toggle="default-modal-{{$detail->product->id}}" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600">Decline</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
