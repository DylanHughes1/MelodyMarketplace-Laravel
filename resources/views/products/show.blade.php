                    ...
                    <form method="POST" class="space-y-6" action="/products/{{$product->id}}#" enctype="multipart/form-data">
                        ...
                        <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" value="{{$product->name}}" name="name" id="name" class="product-name bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                </div>
                                <div>
                                    <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price</label>
                                    <input type="number" value="{{$product->price}}" name="price" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                </div>
                                <div>
                                    <label for="subcategories" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Subcategory</label>
