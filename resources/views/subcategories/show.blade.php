            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="flex items-center justify-center pb-4">
                    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <img class="rounded-t-lg" id="image" src="{{$subcategories->image_link}}" alt="imagen de la categoria{{$subcategories->name}}">
                        ...
                        <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        Categoría: {{$subcategories->category->name}}
                                    </td>   
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="flex items-center justify-center pb-4">
                    ...
                    <form method="POST" action="/subcategories/{{$subcategories->id}}/disable" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
    ...
    <div id="default-modal" aria-hidden="true" class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
        <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
            ...
            <div class="bg-white rounded-lg shadow relative dark:bg-gray-700">
                <form method="POST" class="space-y-6" action="/subcategories/{{$subcategories->id}}#" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{$subcategories->name}}" name="name" id="name" class="product-name bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                        </div>
